        ...
        <div class="card-body">
            ...
            @else
                <form method="POST" action="{{ url('/level/' . $level->level_id) }}" class="form-horizontal">
                    @csrf
                    @method('PUT') <!-- Untuk update data menggunakan method PUT -->

                    <div class="form-group row">
                        <label class="col-1 control-label col-form-label">Code Level</label>
                        <div class="col-11">
                    ...
                    <div class="form-group row">
                        <label class="col-1 control-label col-form-label">Name Level</label>
                        <div class="col-11">
