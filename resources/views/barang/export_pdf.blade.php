...
<body>
    ...
    <table class="border-bottom-header">
        <tr>
            ...
            <td width="85%">
                <span class="text-center d-block font-11 font-bold mb-1">MINISTRY OF EDUCATION, CULTURE, RESEARCH AND
                    TECHNOLOGY</span>
                <span class="text-center d-block font-13 font-bold mb-1">POLYTECHNIC NEGERI MALANG</span>
                <span class="text-center d-block font-10">Jl. Soekarno-Hatta No. 9 Malang 65141</span>
                <span class="text-center d-block font-10">Phone (0341) 404424 Pes. 101-105, 0341-404420, Fax. (0341)
                    404420</span>
    ...
    <h3 class="text-center">Barang DATA REPORT</h3>
        ...
        <tbody>
            @foreach ($barang as $b)
                <tr>
                    ...
                    <td>{{ $b->kategory->kategory_name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
